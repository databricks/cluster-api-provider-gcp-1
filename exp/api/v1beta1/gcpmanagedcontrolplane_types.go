...
type GCPManagedControlPlaneSpec struct {
	...
	// AutoscalingProfile represents the autoscaling profile of the GKE cluster.
	// If not specified, the default autoscaling profile is implicitly BALANCED.
...
// AutoscalingProfile enumerates the values for AutoscalingProfile.
